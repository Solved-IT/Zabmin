...
/**
 * Define the BASEURL so we can easily load css/js files
 */
if (empty($_SERVER['HTTPS'])) {
    $tempUriProtocol = 'http://';
} else {
    $tempUriProtocol = 'https://';
}
define('BASEURL', $tempUriProtocol . $_SERVER['SERVER_NAME'] . '/Zabmin');
